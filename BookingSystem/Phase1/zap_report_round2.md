...
| Info | Informational | http://localhost:8002 | Percentage of responses with status code 3xx | 36 % |
| Info | Exceeded Low | http://localhost:8002 | Percentage of responses with status code 4xx | 17 % |
